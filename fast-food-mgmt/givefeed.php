...
//                            echo  nl2br("\nCould Not place Order\n"); 
                    ...
                    <select name="canteen" id="canteen" style="margin:2vw 4vw; width:60vw;">
                        <option value="919">Canteen 1</option>
                        <option value="943">Canteen 2</option>
                        <option value="2015">Canteen 3</option>
                        <option value="2038">Canteen 4</option>
                        <option value="2299">Canteen 5</option>
                    </select>
                    <br>
