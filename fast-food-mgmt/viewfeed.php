...
<html>
    ...
    <body>
        ...
        <section class="section-cant">
            <div class="row">
                <h3 style="margin-left:32vw;"><strong>CANTEEN 1</strong></h3>
                    <?php
            ...
            <div class="row">
                <h3 style="margin-left:32vw;"><strong>CANTEEN 2</strong></h3>
                    <?php
            ...
            <div class="row">
                <h3 style="margin-left:32vw;"><strong>CANTEEN 3</strong></h3>
                    <?php
            ...
            <div class="row">
                <h3 style="margin-left:32vw;"><strong>CANTEEN 4</strong></h3>
                    <?php
            ...
            <div class="row">
                <h3 style="margin-left:32vw;"><strong>CANTEEN 5</strong></h3>
                    <?php
